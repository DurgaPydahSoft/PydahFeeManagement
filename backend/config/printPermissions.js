...
module.exports = {
    ...
    permissions: {
        'fee-management': ['fee-receipt', 'concession-report', 'cashier-report', 'college-report', 'daily-report', 'fee-configuration-report', 'account-report', 'overall-concession-register', 'overall-concession-list'],
